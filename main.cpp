...
int main() {
    ...
    program.add_method("Average", {
        ...
        Opcode(Bytecode::f32Div,
               ...
               LocalAddress{8}, 2.0f, LocalAddress{0}),
        Opcode(Bytecode::Ret,
               DataLoc::C, DataLoc::C, DataLoc::L,
               (int)0, (int)0, LocalAddress{4})
    });
    ...
    program.add_method("func5", {
        ...
        Opcode(Bytecode::f32Set,
               ...
               GlobalAddress{0}, LocalAddress{0}, 0.0f),
        Opcode(Bytecode::f32Set,
               DataLoc::G, DataLoc::L, DataLoc::C,
    ...
    program.add_method("func4", {
        ...
        Opcode(Bytecode::f32Add,
               ...
               GlobalAddress{0}, 1.0f, LocalAddress{0}),
        Opcode(Bytecode::f32Add,
               DataLoc::G, DataLoc::C, DataLoc::L,
    ...
    //           GlobalAddress{0}, LocalAddress{0}, LocalAddress{0}),
        Opcode(Bytecode::f32Mul,
               DataLoc::L, DataLoc::C, DataLoc::L,
               LocalAddress{0}, 2.0f, LocalAddress{4}),
        Opcode(Bytecode::f32Add,
               DataLoc::G, DataLoc::L, DataLoc::G,
    ...
    program.add_method("func3", {
        ...
        Opcode(Bytecode::f32Mul,
               ...
               GlobalAddress{0}, 2.1f, GlobalAddress{0}),
        Opcode(Bytecode::Ret,
               DataLoc::C, DataLoc::C, DataLoc::L,
               (int)0, (int)0, LocalAddress{0})
     });
    ...
    program.add_method("func2", {
        ...
        Opcode(Bytecode::f32Div,
               DataLoc::G, DataLoc::C, DataLoc::G,
               GlobalAddress{0}, 3.5f, GlobalAddress{0}),
        Opcode(Bytecode::Ret,
               DataLoc::C, DataLoc::C, DataLoc::L,
               (int)0, (int)0, LocalAddress{0})
    });
    ...
    program.add_method("Recursion", {
        ...
        Opcode(Bytecode::s32JLT,
               DataLoc::L, DataLoc::C, DataLoc::L,
               LocalAddress{0}, (int)1, LocalAddress{2}),
        ...
        Opcode(Bytecode::f32Mul,
               DataLoc::G, DataLoc::C, DataLoc::G,
               GlobalAddress{0}, 1.5f, GlobalAddress{0}),
        Opcode(Bytecode::Ret,
               DataLoc::C, DataLoc::C, DataLoc::L,
               (int)0, (int)0, LocalAddress{4})
    });
    ...
    program.add_method("main", {
        ...
        Opcode(Bytecode::f32Set,
               ...
               0.0f, GlobalAddress{0}, 0.0f),
        Opcode(Bytecode::f32Set,
               DataLoc::C, DataLoc::L, DataLoc::C,
               0.0f, LocalAddress{0}, 0.0f),
        Opcode(Bytecode::f32JGT,
               DataLoc::L, DataLoc::C, DataLoc::L,
               LocalAddress{0}, iterate_to, LocalAddress{9}),
        Opcode(Bytecode::f32Set,
               DataLoc::L, DataLoc::L, DataLoc::C,
               LocalAddress{0}, LocalAddress{8}, 0.0f),
    //    Opcode(Bytecode::CallExtern,
    //           DataLoc::G, DataLoc::L, DataLoc::C,
    ...
    //           GlobalAddress{0}, LocalAddress{0}, 0),
        ...
        Opcode(Bytecode::f32Add,
               DataLoc::L, DataLoc::C, DataLoc::L,
               LocalAddress{0}, 0.25f, LocalAddress{0}),
        Opcode(Bytecode::Jump,
